...
| TC-005       | Bookmarked Queries Not Displayed After Applying Jurisdiction Filter on Page 2 | User is logged in | 1. Go to the landing page<br>2. Click on Sign In<br>3. Skip tour<br>4. Click on Session History>br>5. Check filter |Bookmarked queries matching the selected jurisdiction should be displayed | Fail | none        | Release 18.0   |03/02/2026  | Tarurendra  |  v1.26.2.2  |
