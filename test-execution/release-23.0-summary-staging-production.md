# Release 23.0 Bug and Test Summary

**Release Milestone:** Release 23.0  
**Version**:  v1.26.3.3
**Date:** 2026-03-05
...
| #121  | TC-072       | Medium  | Query Session Discrepancy | Open | @dev1 | When accessing an existing Archai Assistant session directly via its URL (session ID), the session does not show recommended followup questions. Additionally, the jurisdiction name fails to load when the URL is opened in an an incognito tab or another browser, though it successfully loads if opened in a new tab within the same active browser session.|
