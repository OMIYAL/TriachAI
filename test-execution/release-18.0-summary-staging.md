# Release 18.0 Bug and Test Summary

**Release Milestone:** Release 18.0  
**Version**:  v1.26.2.2
**Date:** 2026-02-03
...
| #115   | TC-066       | Medium  | Sessions Not Displayed After Applying Jurisdiction Filter on Page 2 | Open | @dev1 |Session Filter Fails When Jurisdiction Is Selected After Navigating to Page 2 |
| #113   | TC-067       | Medium  | Search Text Display Issue on Mobile & Desktop | Open | @dev1 |Verification Emails Delivered to Spam Folder|
| #116   | TC-068       | Medium  | Bookmarked Queries Not Displayed After Applying Jurisdiction Filter on Page 2 | Open | @dev1 |Bookmarked Queries Filter Fails When Jurisdiction Is Selected After Navigating to Page 2|
...
| #114   | TC-067       | Medium  | Real-Time Query Counter Not Updating| Open | @dev1 |Real-Time Query Counter Does Not Update Automatically(B2B, B2C)|
